class Tarefa:
    def __init__(self, id_tarefa, titulo, descricao, status, id_usuario):
    ...
    def __str__(self):
        return f"ID: {self.__id_tarefa}, Título: {self.__titulo}, Descrição: {self.__descricao}, Status: {self.__status}, Usuário: {self.__id_usuario}"
